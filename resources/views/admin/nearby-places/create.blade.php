...
@section('title', 'Tambah Foto / Produk Toko')
...
<div class="mb-6 flex items-center gap-4">
    ...
    <div>
        <h1 class="text-2xl font-bold text-gray-900">Tambah Foto / Produk Toko</h1>
    </div>
</div>
    ...
    <form action="{{ route('admin.nearby-places.store') }}" method="POST" enctype="multipart/form-data" class="p-6 sm:p-8 space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="category" id="category" value="{{ old('category') }}" placeholder="Contoh: Sembako, Minuman, Snack" required
                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm">
            ...
            <div>
                ...
                <input type="text" name="distance" id="distance" value="{{ old('distance') }}" placeholder="Contoh: Rp 15.000 / Kemasan 1 Liter"
                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm">
