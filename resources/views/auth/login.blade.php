...
<div class="max-w-md mx-auto px-4 py-12">
    ...
    <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-6 md:p-8">
        ...
        {{-- Google Login --}}
        <a href="{{ route('auth.google') }}" class="w-full inline-flex items-center justify-center px-4 py-2.5 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition">
