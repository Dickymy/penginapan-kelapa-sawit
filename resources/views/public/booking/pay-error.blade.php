...
<div class="min-h-[60vh] flex items-center justify-center px-4 py-12">
    <div class="max-w-md w-full text-center">
        ...
        <div class="space-y-3">
            ...
            @php
                $waNumber = \App\Models\Setting::get('contact_whatsapp', '');
            @endphp
            @if($waNumber)
            <a href="https://wa.me/{{ $waNumber }}?text=Halo,%20saya%20butuh%20bantuan%20untuk%20booking%20{{ $booking->booking_code }}"
               target="_blank"
