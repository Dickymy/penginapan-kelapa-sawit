...
<div>
    ...
    <div class="space-y-0.5">
        ...
        <a href="{{ route('admin.galleries.index') }}"
           class="flex items-center gap-2.5 px-3 py-2 rounded-lg transition {{ request()->routeIs('admin.galleries.*') ? 'bg-primary-50 text-primary-700 font-medium' : 'text-gray-600 hover:bg-gray-100' }}">
