            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 text-sm">
                ...
                <div class="lg:col-span-1">
                    ...
                    <div class="flex items-center gap-4">
                        <a href="https://www.instagram.com/penginapan_kelapa_sawit?igsi=cmt4djJmdjRpbHFw" target="_blank" class="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center text-gray-400 hover:bg-primary-600 hover:text-white transition-all duration-300">
                        ...
                        <a href="https://www.facebook.com/share/1TYA8LBaTt/?mibextid=wwXIfr" target="_blank" class="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center text-gray-400 hover:bg-primary-600 hover:text-white transition-all duration-300">
