...
<body class="min-h-screen bg-gray-50 font-sans" x-data="{ sidebarOpen: false, moreOpen: false }">
    ...
    <div class="md:flex md:h-screen md:overflow-hidden">
        ...
        <aside x-show="sidebarOpen" x-cloak
               ...
               class="fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-gray-200 flex flex-col md:hidden"
    ...
    <nav class="fixed bottom-0 inset-x-0 z-30 bg-white border-t border-gray-200 md:hidden safe-area-bottom">
        <div class="flex items-center justify-around h-14">
            ...
            <div x-data="{ open: false }" class="relative flex flex-col items-center justify-center w-full h-full">
                ...
                <div x-show="open" x-cloak @click.away="open = false"
                     ...
                     class="absolute bottom-16 bg-white border border-gray-200 rounded-xl shadow-xl py-2 w-48">
                    <a href="{{ route('admin.bookings.create') }}" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50">
                    ...
                    <a href="{{ route('admin.room-blocks.create') }}" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50">
